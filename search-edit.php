    ...
    <script language="javascript">
        function validate() {
            if (document.form1.track.value == "") {
                alert("O número da remessa é obrigatório.");
                                ...
                                <td class="Partext1">
                                    <div align="center">
                                        <table cellpadding="4" cellspacing="0" align="center" width="70%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td colspan="2" class="TrackTitle" valign="top">
                                                        <div class="newtext" align="center"><strong> <br>
                                                                <br>
                                                                Insira o número da remessa <br>
                                                            </strong></div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr bgcolor="EFEFEF">
                                                    <td colspan="2" class="aalpha" bgcolor="#FFFFFF" height="34" valign="top">
                                                        <div class="gentxt" align="center"><strong>Digite o Número da Remessa para MODIFICAR o data. Isto é útil se você cometeu erros ortográficos ao adicionar a remessa.</strong><br>
                                                            <br>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr bgcolor="EFEFEF">
                                                    <form action="search-courier.php" method="post">
                                                        <td valign="top">
                                                            <div align="right">Insira o número da remessa </div>
                                                        </td>
                                                        <td valign="top">
                                                            <div align="left">
